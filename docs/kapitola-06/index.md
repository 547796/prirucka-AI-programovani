...
Úlohy je nutné před použitím do výuky zkontrolovat. Novější modely dělají méně chyb, avšak není zaručená 100% správnost. Problematičtější může být zejména generování testů, které ověřují, zda kód funguje, zde to učitelé mohou využít jako odrazový můstek. Snadné úlohy AI zvládá dobře, ale čím více je úloha náročnější, tím se zvyšuje pravděpodobnost chyby při generování vzorového řešení. Pokud nějakou úlohu AI vygeneruje nesprávně nemusíte hned zahazovat, nebo upravovat aby fungovaly, využijte ji jako debugingové cvičení pro studenty, jak je popsno v kapitole [Debugování kódu s AI](../kapitola-04/index.md).
